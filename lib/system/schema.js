module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '© alfatech'
      ...
      if (!('owners' in setting)) setting.owners = ['254715448094']
      if (!isNumber(setting.lastReset)) setting.lastReset = new Date * 1
      if (!('msg' in setting)) setting.msg = 'Hello +tag 🙂\nI am ALFABOT.An automated system (WhatsApp Bot) that can help yo do daily WhatsApp tasks, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.alfatech.co.ke\n◦ *Source* : https://wa.me/+254715448094\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      ...
      global.db.setting = {
         ...
         msg: 'Hello +tag 🙂\nI am *ALFABOT* .An automated system (WhatsApp Bot) that can help you do daily WhatsApp tasks, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.alfatech.co.ke\n◦ *Source* : https://wa.me/+254715448094\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 2,
